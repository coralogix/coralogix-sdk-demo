...
func (c *logs2MetricServiceClient) ListLabelsCardinality(ctx context.Context, in *ListLabelsCardinalityRequest, opts ...grpc.CallOption) (*ListLabelsCardinalityResponse, error) {
	out := new(ListLabelsCardinalityResponse)
	err := c.cc.Invoke(ctx, "/com.coralogixapis.logs2metrics.v2.Logs2MetricService/ListLabelsCardinality", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLogs2MetricServiceServer) ListLabelsCardinality(context.Context, *ListLabelsCardinalityRequest) (*ListLabelsCardinalityResponse, error) {
...
func _Logs2MetricService_ListLabelsCardinality_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListLabelsCardinalityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(Logs2MetricServiceServer).ListLabelsCardinality(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.coralogixapis.logs2metrics.v2.Logs2MetricService/ListLabelsCardinality",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(Logs2MetricServiceServer).ListLabelsCardinality(ctx, req.(*ListLabelsCardinalityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Logs2MetricService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Logs2MetricService_ListLabelsCardinality_Handler,
		},
	},
